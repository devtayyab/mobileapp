...
const createStyles = (Colors: Palette) => StyleSheet.create({
  ...
  searchBar: {
    ...
    backgroundColor: Colors.background.secondary, marginHorizontal: 16, marginTop: 12, marginBottom: 12,
  ...
  cardEmail: { fontSize: 13, color: Colors.text.tertiary, marginTop: 2 },
  cardMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  cardDate: { fontSize: 11, color: Colors.text.tertiary },
  ...
  iconActionBtn: {
    width: 32, height: 32, borderRadius: 8, backgroundColor: Colors.background.primary,
    justifyContent: 'center', alignItems: 'center',
  },
  ...
  heroName: { fontSize: 18, fontWeight: '800', color: Colors.text.primary, textAlign: 'center' },
  ...
  reviewedAt: { fontSize: 12, color: Colors.text.tertiary },
  section: {
  ...
  detailLabel: { fontSize: 13, color: Colors.text.tertiary, fontWeight: '500' },
  detailValue: { fontSize: 13, color: Colors.text.primary, fontWeight: '600', flex: 1, textAlign: 'right', paddingLeft: 8 },
  descriptionBox: { marginTop: 10, backgroundColor: Colors.background.primary, borderRadius: 10, padding: 12 },
  descriptionLabel: { fontSize: 12, fontWeight: '700', color: Colors.text.tertiary, marginBottom: 6 },
  descriptionText: { fontSize: 14, color: Colors.text.primary, lineHeight: 20 },
  ...
  commissionDesc: { fontSize: 13, color: Colors.text.tertiary },
  editLink: { fontSize: 14, fontWeight: '700', color: '#2563EB' },
  commissionEdit: { gap: 12 },
  commissionInputRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: Colors.background.primary, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12,
    borderWidth: 1.5, borderColor: '#059669',
  },
  commissionInput: { flex: 1, fontSize: 20, fontWeight: '700', color: Colors.text.primary },
  ...
  commissionCancelBtn: {
    flex: 1, backgroundColor: Colors.background.primary, borderRadius: 10, paddingVertical: 12,
    alignItems: 'center',
  },
  commissionCancelBtnText: { fontSize: 15, fontWeight: '600', color: Colors.text.primary },
  docRow: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#F9FAFB',
  },
  docIconWrap: {
    width: 36, height: 36, borderRadius: 10, backgroundColor: Colors.background.primary,
    justifyContent: 'center', alignItems: 'center',
  },
  docInfo: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  docType: { fontSize: 14, fontWeight: '600', color: Colors.text.primary, textTransform: 'capitalize' },
  ...
  noDocsText: { fontSize: 14, color: Colors.text.tertiary },
  rejectionBox: {
  ...
  rejectInputLabel: { fontSize: 13, fontWeight: '700', color: Colors.text.primary, marginBottom: 10 },
  rejectInput: {
    backgroundColor: Colors.background.primary, borderWidth: 1.5, borderColor: Colors.border.medium,
    borderRadius: 10, padding: 12, fontSize: 14, color: Colors.text.primary, minHeight: 90,
  },
